...
import { 
    IGetDictionaryActionInProgress, IGetDictionaryActionSuccess, 
    IGetDictionaryActionError, IGetEngagementTypeSuccess, 
    IGetAccountingFrameworkSuccess, IGetAuditingStandardSuccess, 
    IGetCategorySuccess, IGetTicketTypeSuccess, IGetTopicSuccess, 
    IGetStatusSuccess 
...
function onGetDictionarySuccess(
    currentState: IDictionaryState,
    action: (IGetDictionaryActionSuccess| IGetEngagementTypeSuccess 
        |IGetAccountingFrameworkSuccess |IGetAuditingStandardSuccess
        |IGetCategorySuccess|IGetTicketTypeSuccess|IGetTopicSuccess
        |IGetStatusSuccess)
) {
